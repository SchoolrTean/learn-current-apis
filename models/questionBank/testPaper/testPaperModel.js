...
const testPaperSchema = mongoose.Schema({
      ...
      questionsIdsAdded    : [ { type : mongoose.Schema.Types.ObjectId, ref : 'schoolr_question_bank_test_paper_question_model', required:true, trim:true  } ],
      totalMarks           : { type : Number, default:0, required :false, trim:true },
      isActive             : { type : Boolean, default: true },
      date                 : { type : Date, default: () => Date.now() + 5.5*60*60*1000 }
});

module.exports = mongoose.model('schoolr_question_bank_test_paper_model', testPaperSchema);