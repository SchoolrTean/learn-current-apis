...
assignmentSchema.index({ _id : 1, teacherId : 1, groupId : 1, sectionType : 1, eventDate: 1, cancelStatus : 1, date : 1, isActive : 1, stared : 1});

module.exports = mongoose.model('HomeWork', assignmentSchema, 'sc_assignments');