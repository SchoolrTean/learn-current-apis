...
const CreateCoordinatorAccountAndConnect = (schoolName, schoolBranch, schoolAddress, schoolCity, SchoolEmailId, schoolContactNumber, firstName, surName, emailId, mobileNo, schoolId, invitationType) => {
...
const addSchoolCoordinators = (req, res, next) => {
      ...
      if (req.body.schoolId && req.body.firstNameData && req.body.surNameData && req.body.emailIdData && req.body.mobileNoData && req.body.invitationType &&
            ...
            let firstNameData = req.body.firstNameData; //Data
            let surNameData = req.body.surNameData; //Data
            let emailIdData = req.body.emailIdData; //Data
            let mobileNoData = req.body.mobileNoData; //Data
            let invitationType = req.body.invitationType;
                                                      ...
                                                      .then(async registeredUsers => {
                                                            ...
                                                            if (registeredUsers.length > 0) {
                                                                  ...
                                                                  for (let index = 0; index < emailIdList.length; index++) {
                                                                        ...
                                                                        connections.push(CreateCoordinatorAccountAndConnect(schoolData.schoolName, schoolData.schoolBranch, schoolData.schoolAddress, schoolData.schoolCity, schoolData.emailId, schoolData.schoolContactNumber, firstNameList[index], surNameList[index], emailIdList[index], mobileNoList[index], schoolId, invitationType))
...
module.exports = addSchoolCoordinators;