                                                            ...
                                                            if (chapterTests.length > 0) {
                                                                  ...
                                                                  Promise.all([TestQuestions, TestResults])
                                                                        .then(result => {
                                                                              ...
                                                                              let totalChapterTestQuestionsCount = 0;
                                                                              ...
                                                                              if (result[0].length == 0) {
                                                                                    ...
                                                                                    if (result[1].length == 0) {
                                                                                          ...
                                                                                          for (let index = 0; index < chapterTests.length; index++) {
                                                                                                ...
                                                                                                totalChapterTestQuestionsCount += test.totalTestQuestionsCount
                                                                              ...
                                                                              return res.status(200).json({
                                                                                    ...
                                                                                    chapterDetails: {
                                                                                          ...
                                                                                          totalChapterQuestionCount: totalChapterTestQuestionsCount
                                                                                    },
