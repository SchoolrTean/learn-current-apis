...
const NoTopicExercises = (req, res) => {
                                                ...
                                                ExerciseModel.find({
                                                      ...
                                                      .then(chapterExercises => {
                                                            ...
                                                            if (chapterExercises.length > 0) {
                                                                  ...
                                                                  let exerciesIdList = chapterExercises.map(exercise => exercise._id)
                                                                  ...
                                                                  Promise.all([exerciseWiseQuestionCount, exerciseWiseQuestionsUserAnsweredCount, SelectedExerciseQuestions, SelectedExerciseUserAnswers])
                                                                        .then(result => {
                                                                              ...
                                                                              if (result[0].length == 0) {
                                                                                    ...
                                                                                    questionList.map(questionDetails => {

                                                                                          totalQuestionCount = questionDetails.subQuestions && questionDetails.subQuestions.length > 0 ? totalQuestionCount + 1 : totalQuestionCount;
...
module.exports = NoTopicExercises