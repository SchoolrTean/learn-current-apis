...
module.exports = (req, res, next) => {
    ...
    if (req.body.teacherId && req.body.classId && req.body.subjectName && req.body.chapterName && req.body.questionType < 4 && req.body.marks && (req.body.question || questionUrl) &&
        ...
        VerifyTeacher(teacherId, classId, async (error, response) => {
            ...
            if (response && response.statusCode != "0" && response.classData) {
                ...
                const NewQuestion = new TestPaperQuestionModel({
