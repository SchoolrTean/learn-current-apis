...
module.exports = (req, res, next) => {
    ...
    if (req.params.teacherId && req.params.classId && req.params.questionId && req.body.subjectName && req.body.chapterName && req.body.questionType < 4 && (req.body.question || questionUrl) &&
