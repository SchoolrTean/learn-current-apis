...
const insertBroadcast = (teacherId, teacherName, groupId, groupName, announcementTitle, announcementDate, announcement, studentConfirmation, fileUrls, scheduledDateAndTime, updateType, previousAnnouncementId = null, previousAnnouncementDate = null) => {
      ...
      return new Promise(async (resolve, reject) => {
            ...
            const AnnouncementData = new AssignmentModel({
            ...
            if (scheduledDateAndTime) {
                  AnnouncementData.scheduledDateAndTime = scheduledDateAndTime
            }
            if (announcementDate) {
                  AnnouncementData.eventDate = announcementDate
            }
                                          ...
                                          if (groupsData.groupsCount == groupIdArray.length) {
                                                ...
                                                if (((announcementDate && daysDiff < 0) || !announcementDate) && ((scheduleDaysDiff < 0 && scheduledDateAndTime) || !scheduledDateAndTime)) {
                                                      ...
                                                      while (index < groupIdArray.length) {
                                                            ...
                                                            insertedAnnoucements.push(insertBroadcast(teacherId, response.teacherData.firstName, response.classData[index]._id, groupName, announcementTitle, announcementDate, announcement, studentConfirmationData, fileUrls, scheduledDateAndTime, updateType)) // update type 1 is used to send notification as new assignment
                              ...
                              .then(Announcement => {
                                    ...
                                    if (Announcement) {
                                          ...
                                          res.status(200).json({
                                                ...
                                                "eventDate": Announcement.eventDate ? Announcement.eventDate : "",
                                                "announcement": Announcement.announcement ? Announcement.announcement : "",
                                                "studentConfirmation": Announcement.studentConfirmation,
                                                      ...
                                                      ConnectedStudentsGroupCount(groupId)
                                                            .then(async groupsData => {
                                                                  ...
                                                                  if (groupsData.groupsCount == 1) {
                                                                        ...
                                                                        insertBroadcast(teacherId, response.teacherData.firstName, groupId, groupName, announcementTitle, announcementDate, announcement, studentConfirmationData, fileUrls, scheduledDateAndTime, updateType, announcementId, recordFound.date)
                                                ...
                                                .then(groupsData => {
                                                      ...
                                                      if (groupsData.groupsCount == groupIdArray.length) {
                                                            ...
                                                            for (let index = 0; index < response.classData.length; index++) {
                                                                  ...
                                                                  insertedAnnoucements.push(insertBroadcast(teacherId, response.teacherData.firstName, groupDetails._id, groupName, announcementTitle, announcementDate, announcement, studentConfirmationData, fileUrls, "", 1)) //1- specifies notification should be sent as new one
                                                            }
...
exports.viewAnnouncement = (req, res, next) => {

      if (req.params.teacherId && req.params.classId && req.params.announcementId) {
                        ...
                        AssignmentModel.findOne({
                              ...
                              .then(async result => {
                                    ...
                                    if (result) {
                                          ...
                                          let formattedToday = await formatDate(new Date())
                                          let completionDate = result.eventDate ? await formatDate(result.eventDate) : await formatDate(result.date)
                                          let completionDayDiff = new DateDiff(new Date(formattedToday), new Date(completionDate));
                                          ...
                                          res.status(200).json({
                                                ...
                                                completedStudentsCount: result.coming.length,
                                                inCompletedStudentsCount: result.notComing.length,
